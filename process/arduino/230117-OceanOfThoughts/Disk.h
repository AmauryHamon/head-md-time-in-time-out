...
#define ringCount 6 // total Number of Rings

//Map rings on disk to indicies.
//This is where all the magic happens.
//Each represents one of the concentric rings.

//This is for a 93 LEDS ring lamp from DFROBOT
// https://wiki.dfrobot.com/93_LEDs_WS2812B_RGB_6_Ring_Lamp_SKU_FIT0676
uint8_t rings[ringCount][2] = {
  {92, 92},   //0 Center Point
  {84, 91},   //1
  {72, 83},   //2
  {56, 71},   //3
  {32, 55},   //4
